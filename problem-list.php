...
opacity: 1;  
    ...
    <div id="topbar" style="width: 100%;">
                    ...
                    <a style="color: black;" href="index.php"><li> মানচিত্রে খুঁজুন</li></a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
                        <a style="color: black;" href="solution-list.php"><li> সমাধান গুলো</li></a>
        ...
        <?php 
            ...
            ?>
            <div class="pin">
                <div class="problemName">নামঃ<?php echo $row['name']; ?></div>
                <div class="problemDesc">বর্ণনাঃ<?php echo $row['description']; ?></div>
                <div class="problemRating">রেটিংঃ<?php echo $row['rating']; ?></div>
                ...
                <br/>
                <button id="rate" onclick="rateIt('<?php echo $row['id']; ?>')">Rate The Severity Of this Problem</button>
                <br/><button id="sol" onclick="sol(<?php echo $row['id']; ?>)">Add a solution!</button>
                <a href="rateSol.php?id=<?php echo $row['id']; ?>"><button id="sol" >See solutions!</button></a>
            </div>
        <?php    
            }
        ?>  
